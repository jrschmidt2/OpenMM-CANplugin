...
void test_CO2() {
	...
	cparams[0]=1.420759e+02;
	cparams[1]=0.000000e+00;
	cparams[2]=4.031460e-01;
	cparams[3]=0.000000e+00;
	cparams[4]=1.411444e+02;
	cparams[5]=0.000000e+00;
	cparams[6]=9.767920e-01;
	cparams[7]=0.000000e+00;
	cparams[8]=1.751437e+01;
	cparams[9]=0.000000e+00;
	cparams[10]=-1.000000e+00;
	cparams[11]=0.000000e+00;
	cparams[12]=1.677826e+01;
	cparams[13]=0.000000e+00;
	cparams[14]=-1.000000e+00;
	cparams[15]=0.000000e+00;
	cparams[16]=1.000000e+00;
	cparams[17]=0.000000e+00;
	cparams[18]=7.279010e-01;
	cparams[19]=0.000000e+00;
	cparams[20]=4.352466e+01;
	cparams[21]=1.262157e-03;
	cparams[22]=6.962318e-05;
	cparams[23]=3.262527e-06;
	cparams[24]=2.019001e-07;
	vector<double> oparams(25);
	oparams[0]=1.869946e+02;
	oparams[1]=1.962800e-02;
	oparams[2]=-8.579300e-02;
	oparams[3]=0.000000e+00;
	oparams[4]=8.763936e+01;
	oparams[5]=-2.091420e-01;
	oparams[6]=-2.282340e-01;
	oparams[7]=0.000000e+00;
	oparams[8]=3.716547e+01;
	oparams[9]=1.000000e+00;
	oparams[10]=4.746770e-01;
	oparams[11]=0.000000e+00;
	oparams[12]=2.901110e+01;
	oparams[13]=-1.000000e+00;
	oparams[14]=-5.894530e-01;
	oparams[15]=0.000000e+00;
	oparams[16]=1.000000e+00;
	oparams[17]=1.556490e-01;
	oparams[18]=1.121930e-01;
	oparams[19]=0.000000e+00;
	oparams[20]=4.452011e+01;
	oparams[21]=9.540046e-04;
	oparams[22]=4.693183e-05;
	oparams[23]=3.163703e-06;
	oparams[24]=1.458385e-07;
/*	vector<Vec3> positions(6);
	positions[0] = Vec3(0.710,0.710,0.710);
	positions[1] = Vec3(0.000, 0.000, 0.000);	
	positions[2] = Vec3(1.420,1.420,1.420);	
	positions[3] = Vec3(0.710,1.010,0.710);	
	positions[4] = Vec3(0.000,0.300,0.000);
	positions[5] = Vec3(1.420,1.710,1.420);
*/
	vector<Vec3> positions(9);
	positions[0] = Vec3(4.752,   3.752,   4.752);  
	positions[1] = Vec3(5.418,   4.418,   5.418);
	positions[2] = Vec3(4.086,   3.086,   4.086);
	positions[3] = Vec3(4.752,   3.752,   5.752);  
	positions[4] = Vec3(5.418,   4.418,   6.418);
	positions[5] = Vec3(4.086,   3.086,   5.086);
	positions[6] = Vec3(4.752,   3.752,   6.752);  
	positions[7] = Vec3(5.418,   4.418,   7.418);
	positions[8] = Vec3(4.086,   3.086,   8.086);
