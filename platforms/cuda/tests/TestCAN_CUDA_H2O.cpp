...
void test_H2O() {
	...
	forceField->addParticle(O_params,1,-1,1,2); //0
	forceField->addParticle(H_params,2,1,2,0); //1
	forceField->addParticle(H_params,2,1,2,0); //2
	forceField->addParticle(O_params,1,-1,4,5);  //3
	forceField->addParticle(H_params,2,4,5,3); //4
	forceField->addParticle(H_params,2,4,5,3); //5
