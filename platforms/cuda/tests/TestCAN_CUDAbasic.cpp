...
void test_theta() {
	...
	cout << state.getPotentialEnergy() << " should be " << 2*sin3 << endl;
}
...
void test_phi() {
	...
	cout << state.getPotentialEnergy() << " should be " << sin4 << endl;
}

void test_theta2() {
	cout << "TEST THETA1 & THETA2" << endl;
	System system;
	system.addParticle(1.0);
	system.addParticle(1.0);
	system.addParticle(1.0);
...
void testMultipleCutoffs() {
	cout << "TEST MULTIPLE CUTOFFS" << endl;
    System system;
    system.addParticle(1.0);
    system.addParticle(1.0);
    VerletIntegrator integrator(0.01);
